...
HRESULT D3DFramework::initDevice()
{
	...
	loadModel("models/moon_high_res.obj");
...
void D3DFramework::logAverageFPS()
{
	...
	if (frameCounter >= 1000)
	{
		...
		float averageFPS = frameCounter / totalTime;

		std::ostringstream oss;
		oss << "[FPS INFO] Average FPS over 1000 frames: " << averageFPS << "\n";
